...
<section class="footer-block col-sm-6 col-md-3 col-sms-6 col-smb-12">
	<h4 class="footer-static-title"><a href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}" title="{l s='Manage my customer account' mod='blockmyaccountfooter'}" rel="nofollow">{l s='My account' mod='blockmyaccountfooter'}</a></h4>
